  ...
  const bgImages = (
    <div className="absolute inset-0 overflow-hidden">
      <div className="absolute inset-0 md:right-1/2">
        <Image unoptimized src={cateringImg1} alt="" fill sizes="(max-width: 768px) 100vw, 50vw" placeholder="blur" className="object-cover" />
      </div>
      <div className="absolute inset-y-0 left-1/2 right-0 max-md:hidden">
        <Image unoptimized src={cateringImg2} alt="" fill sizes="50vw" placeholder="blur" className="object-cover" />
      </div>
    ...
    return (
      <div className="relative min-h-screen flex items-center justify-center px-6 -mt-24 pt-24">
        ...
        <div className="relative bg-4/80 backdrop-blur-sm rounded-2xl p-10 text-center max-w-sm">
          ...
          <p className="text-2">Vi tar kontakt med et tilbud på e-post. Bestillingen er ikke bekreftet før du har hørt fra oss.</p>
        </div>
      </div>
    )
  }
