      ...
      <div className="max-w-6xl mx-auto px-6 md:px-10 lg:px-6 w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center pt-12 pb-16 md:py-16 lg:py-24">
        <div className="max-md:text-center">
          ...
          <Link
            ...
            className="inline-block px-6 pt-2 pb-1 lg:px-8 lg:pt-3 lg:pb-2 bg-1 text-4 text-base lg:text-lg font-special-elite rounded-lg shadow-sm shadow-1/30 hover:brightness-125 transition-all"
          >
            Reserver bord
          </Link>
        </div>
